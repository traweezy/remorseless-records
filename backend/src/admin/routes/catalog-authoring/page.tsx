...
const buildEmptyVariantProfile = (
  variantId: string
  ...
  ({ productId }) => {
    ...
    const refreshAll = useCallback(async () => {
      ...
      try {
        ...
        setError(
          err instanceof Error ? err.message : "Unable to load catalog data"
        )
      } finally {
        setLoading(false)
      }
    ...
    const removeArtistLine = useCallback(
      (key: string) => {
        setProfileForm((prev) => ({
          ...prev,
    ...
    const updateBundleField = useCallback(
      (
        field: keyof Omit<BundleFormState, "components">,
      ...
      (key: string, productId: string) => {
        ...
        updateBundleComponent(key, {
          ...
          variantTitle: firstVariant
            ? formatBundleVariantLabel(firstVariant)
            : "",
    ...
    const saveProduct = useCallback(async () => {
      ...
      try {
        ...
        const referenceLines = profileForm.references.filter(
          (reference) =>
            reference.referenceValueId.trim() || reference.label.trim()
        )
        const bundleComponentLines = bundleForm.components.filter((component) =>
          component.componentProductId.trim()
        )
        ...
        const profilePayload = {
          ...
          artists: artistLines.map((artist, index) => ({
            ...
            displayName:
              toNullable(artist.displayName) ?? toNullable(artist.name),
          ...
          references: referenceLines.map((reference, index) => ({
            ...
            label: reference.referenceValueId
              ? undefined
              : toNullable(reference.label),
            sortOrder: index,
          })),
        }
              ...
              <div className="flex min-w-0 flex-col">
                ...
                <div className="min-w-0 space-y-8 p-5">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            updateProductField("title")(readValue(event))
                          }
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            updateProductField("handle")(readValue(event))
                          }
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          onChange={(event) =>
                            setProfileForm((prev) => ({
                              ...
                              labelLabel:
                                references.find(
                                  (value) => value.id === readValue(event)
                        ...
                        >
                          ...
                          {(referencesByKind.get("label") ?? []).map(
                            (reference) => (
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          {(referencesByKind.get("product_type") ?? []).map(
                            (reference) => (
                              <option key={reference.id} value={reference.id}>
                                {reference.label}
                              </option>
                        ...
                        {!profileForm.productTypeId ? (
                          <Input
                            ...
                            onChange={(event) =>
                              updateProfileField("productTypeLabel")(
                                readValue(event)
                              )
                            }
                          />
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              updateProfileField("releaseDate")(
                                readValue(event)
                              )
                            }
                          />
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              updateProfileField("releaseYear")(
                                readValue(event)
                              )
                            }
                          />
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            updateProfileField("searchKeywords")(
                              readValue(event)
                            )
                          }
                        />
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {profileForm.artists.map((line) => (
                        <div
                          key={line.key}
                          className="grid gap-3 rounded-md border border-ui-border-base p-3 lg:grid-cols-[1fr,1fr,140px,auto]"
                        >
                          <div className="space-y-2">
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <Heading level="h3">
                        Genres, tags, and controlled values
                      </Heading>
                      <div className="flex flex-wrap gap-2">
                        <Button
                          type="button"
                          size="small"
                          variant="secondary"
                          onClick={() => addReferenceLine("genre")}
                        >
                          Add genre
                        </Button>
                        <Button
                          ...
                          size="small"
                          variant="secondary"
                          onClick={() => addReferenceLine("utility_tag")}
                        >
                          Add tag
                        </Button>
                        <Button
                          ...
                          size="small"
                          variant="secondary"
                          onClick={() => addReferenceLine("merch_type")}
                        >
                          Add merch type
                        </Button>
                      </div>
                    ...
                    <div className="space-y-3">
                      {profileForm.references.map((line) => {
                        ...
                        return (
                          <div
                            key={line.key}
                            className="grid gap-3 rounded-md border border-ui-border-base p-3 lg:grid-cols-[160px,1fr,1fr,auto]"
                          >
                            <div className="space-y-2">
                              <Label>Kind</Label>
                              <select
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          onChange={(event) =>
                            updateProfileField("tracklistJson")(
                              readValue(event)
                            )
                          }
                        />
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          onChange={(event) =>
                            updateProfileField("pressingNotesJson")(
                              readValue(event)
                            )
                          }
                        />
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          onChange={(event) =>
                            updateProfileField("merchDetailsJson")(
                              readValue(event)
                            )
                          }
                        />
                    ...
                    <div className="min-w-0 space-y-4">
                      {(selectedProduct.variants ?? []).map((variant) => {
                        ...
                        return (
                          <div
                            key={variant.id}
                            className="min-w-0 space-y-4 rounded-md border border-ui-border-base p-4"
                          >
                            <div className="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                              ...
                              <Text
                                size="xsmall"
                                className="break-all text-ui-fg-muted"
                              >
                                {variant.id}
                              </Text>
                            </div>
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <select
                                  ...
                                  onChange={(event) => {
                                    ...
                                    updateVariantLine(variant.id, {
                                      formatId,
                                      formatLabel:
                                        reference?.label ?? line.formatLabel,
                                    })
                                  }}
                                  className="min-h-9 w-full rounded-md border border-ui-border-base bg-ui-bg-base px-2 text-ui-fg-base"
                                >
                                  <option value="">New format</option>
                                  {(referencesByKind.get("format") ?? []).map(
                                    (reference) => (
                                      <option
                                        key={reference.id}
                                        value={reference.id}
                              ...
                              <div className="space-y-2">
                                ...
                                >
                                  ...
                                  {(
                                    referencesByKind.get("format_detail") ?? []
                                  ).map((reference) => (
                                    <option
                                      key={reference.id}
                                      value={reference.id}
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                          <div aria-live="polite">
                            ...
                            {productOptionStatus === "ready" ? (
                              <Text size="xsmall" className="text-ui-fg-subtle">
                                {selectableProducts.length} product choices
                                available
                              </Text>
                            ) : null}
                            {productOptionsError ? (
                        ...
                        >
                          {bundleForm.components.map((component) => {
                            ...
                            return (
                              <div
                                key={component.key}
                                className="grid gap-3 rounded-md border border-ui-border-base p-3 lg:grid-cols-[1fr,1fr,90px,auto]"
                              >
                                <div className="space-y-2">
                                  <Label>Product</Label>
                                  <select
                                ...
                                <div className="flex items-end">
                                  <Button
                                    ...
                                    variant="secondary"
                                    onClick={() =>
                                      removeBundleComponent(component.key)
                                    }
                                  >
                                    <Trash className="h-4 w-4" />
                                  </Button>
...
ProductAuthoringWorkspaceContent.displayName =
...
export const ProductAuthoringWorkspace = memo<ProductAuthoringWorkspaceProps>(
  ({ productId }) => (
    ...
    >
      <ProductAuthoringWorkspaceContent {...(productId ? { productId } : {})} />
    </AdminPermissionBoundary>
  )
)
