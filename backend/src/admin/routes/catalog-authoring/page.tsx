                          ...
                          <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <label className="flex items-center gap-2 text-sm text-ui-fg-base">
                              <input
                                ...
                                onChange={(event) =>
                                  updateVariantLine(variant.id, {
                                    backorderAllowed: event.currentTarget.checked,
                                  })
                                }
                              />
                              Backorder allowed
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <label className="flex items-center gap-2 text-sm text-ui-fg-base">
                      <input
                        ...
                        onChange={(event) =>
                          updateBundleField("enabled", event.currentTarget.checked)
                        }
                      />
                      Enable bundle
                    </label>
                      ...
                      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <label className="flex items-end gap-2 pb-2 text-sm text-ui-fg-base">
                          <input
                            ...
                            onChange={(event) =>
                              updateBundleField("isActive", event.currentTarget.checked)
                            }
                          />
                          Active
                        </label>
