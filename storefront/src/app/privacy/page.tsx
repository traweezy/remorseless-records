...
const PrivacyPage = () => (
  ...
  >
    <LegalSection title="Data We Collect">
      <p>
        We collect only the information needed to operate storefront services,
        including:
      </p>
    ...
    <LegalSection title="How We Use Data">
      <p>
        Personal information is used for order fulfillment, customer support,
        fraud prevention, legal compliance, and service operations.
      </p>
      <p>
        We do not intentionally collect sensitive categories of personal data
        unless required for fraud prevention or legal obligations.
      </p>
    </LegalSection>

    <LegalSection title="Service Providers and Sharing">
      <p>
        We share data with processors that support order fulfillment and
        operations, including {legalConfig.privacy.processors.join(", ")}.
      </p>
      <p>
        We do not sell personal information for money. If state-law “sale” or
        “sharing” obligations apply in the future, this policy and controls will
    ...
    <LegalSection title="Retention">
      <ul className="list-disc space-y-1 pl-5">
        <li>
          Order and invoice records: {legalConfig.privacy.retention.orders}
        </li>
        <li>Support communications: {legalConfig.privacy.retention.support}</li>
        <li>
          Marketing suppression records:{" "}
          {legalConfig.privacy.retention.marketingSuppression}
        </li>
        <li>
          Privacy request records:{" "}
          {legalConfig.privacy.retention.privacyRequests}
        </li>
      </ul>
    </LegalSection>
    ...
    <LegalSection title="Your Rights and Requests">
      <p>
        ...
        deletion, or portability of personal data, and may object to certain
        processing.
      </p>
      <p>
        We verify request identity before fulfillment and retain request logs
        for compliance evidence.
      </p>
      <p>
        To submit a request now, use the form below. For cookie-specific
        controls, visit{" "}
        <SmartLink
          href={legalRoutes.cookies}
          className="text-destructive underline underline-offset-4"
