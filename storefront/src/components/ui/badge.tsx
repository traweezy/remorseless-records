...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[0.7rem] font-semibold uppercase tracking-[0.14rem] transition-colors hover:brightness-95 hover:bg-border/20 sm:tracking-[0.24rem]",
  {
    variants: {
      variant: {
