  ...
  return (
    <>
      ...
      >
        ...
        >
          <Card className="relative flex h-full flex-col overflow-visible rounded-[1.75rem] border-2 border-border/60 bg-background/80 shadow-[0_20px_45px_-30px_rgba(0,0,0,0.7)] transition hover:-translate-y-1 hover:border-destructive/70 hover:shadow-[0_30px_65px_-40px_rgba(0,0,0,0.9)] focus-within:-translate-y-1 focus-within:border-destructive/70 focus-within:shadow-[0_30px_65px_-40px_rgba(0,0,0,0.9)]">
            {badge ? (
              ...
              <div className="relative z-10 aspect-square overflow-hidden bg-card">
                {thumbnail ? (
                  ...
                  <img
                    ...
                    className="h-full w-full object-cover transition duration-300 group-hover:scale-[1.02] group-hover:rotate-[0.5deg] group-hover:brightness-[0.9] group-focus-within:scale-[1.02] group-focus-within:rotate-[0.5deg] group-focus-within:brightness-[0.9]"
                    loading="lazy"
                  />
                ) : (
