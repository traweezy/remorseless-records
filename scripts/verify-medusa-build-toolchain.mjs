...
execFileSync(
  ...
  [
    ...
    join(
      ...
      "src",
      "scripts",
      "rewrite-runtime-aliases.test.cjs"
    ),
  ],
  {
    cwd: repositoryRoot,
...
console.log(
  "Medusa build toolchain verified: Framework resolves TypeScript 5.9.3; launcher, SWC compiler, and runtime alias cases pass without package-manager auto-installation."
)
