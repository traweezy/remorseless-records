...
const postgresObservabilityCoverageCommand =
...
export const validateCiSharedContracts = ({
  ...
  assert.equal(
    scripts["qa:postgres-observability-preflight"],
    postgresObservabilityCoverageCommand,
    "PostgreSQL observability preflight coverage/test scope must remain enforced"
  )
  assert.equal(
